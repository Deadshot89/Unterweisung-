...
- Freigegebene Sprachfassungen werden für Teilnehmer getrennt aufgelöst. Sobald eine analysierte Fassung veröffentlicht ist, benötigen Teilnehmer in anderen Sprachen ebenfalls eine freigegebene Sprachfassung; es gibt keinen stillen Rückfall auf anderssprachige Inhalte. Neue Tests enthalten alle freigegebenen Aspekte, auch mehr als sieben Fragen. Quelle, Text, Fragen und Lösungsschlüssel werden beim ersten Öffnen als vollständiger Prüfungsstand gespeichert. Spätere Änderungen beeinflussen die laufende Prüfung nicht.
