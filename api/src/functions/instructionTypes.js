    ...
    try {
      ...
      if (request.method === 'POST') {
        ...
        await pool.request()
          ...
          .input('description', sql.NVarChar(sql.MAX), clean(body.description, 4000))
      ...
      await pool.request()
        ...
        .input('description', sql.NVarChar(sql.MAX), body.description === undefined ? null : clean(body.description, 4000))
