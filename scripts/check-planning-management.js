...
assert.match(api, /methods:\s*\['GET', 'POST', 'PATCH'\]/, 'Planungs-API muss GET, POST und PATCH unterstützen.');
assert.match(api, /Roles\.SYSTEM_ADMIN, Roles\.COMPANY_ADMIN, Roles\.HSE, Roles\.LINE_MANAGER/, 'Planung muss für passende Rollen erlaubt sein.');
